...
# Вставляй свой контракт +аби и минть что угодно
#Отправляет транзы почередно с рандомной заданной задержкой. Проверяет газ каждые 10сек и отправляет когда доходит до заданных пределов
